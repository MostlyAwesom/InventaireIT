...
Router.map(function() {
    ...
    this.route('TypesMachineUpdate', {
        path: '/proprietes/typesMachine/modification/:_id',
    ...
    this.route('TypesMachineRead', {
        path: '/proprietes/typesMachine/details/:_id',
        template: 'readFormTypesMachineTemplate',
    ...
    this.route('VillesUpdate', {
        path: '/proprietes/villes/modification/:_id',
    ...
    this.route('VillesRead', {
        path: '/proprietes/villes/details/:_id',
        template: 'readFormVillesTemplate',
    ...
    this.route('Utilisateurs', {
        path: '/gestion/utilisateurs',
        template: 'dashboardUtilisateursTemplate',

        data: function(){
            var utilisateurs = Meteor.users.find();
        ...
        waitOn: function(){
            return Meteor.subscribe("Utilisateurs");
        }
    });
});
